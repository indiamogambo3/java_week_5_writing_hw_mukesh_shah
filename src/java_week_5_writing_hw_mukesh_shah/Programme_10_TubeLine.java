...
public class Programme_10_TubeLine {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Please enter the tube station's name in Zone 1: ");

        //Input wizard for the user, and store his/her input as variable
        String userTubeStation = scan.nextLine();
        String catchStationName = "";

        //Checking, if user is present in the list of Zone 1 stations
