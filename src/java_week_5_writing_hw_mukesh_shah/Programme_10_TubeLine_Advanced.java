...
public class Programme_10_TubeLine_Advanced {
    ...
    public static void main(String[] args) {
        ...
        String station[] = ("Aldgate,Angel,Baker Street,Bank,Barbican,Bayswater,Blackfriars,Bond Street," +
                "Borough,Cannon Street,Chancery Lane,Charing Cross,Covent Garden,Earl's Court," +
                "Edgware Road,Elephant & Castle,Embankment,Euston,EustonSquare," +
                "Farringdon,Gloucester Road,Goodge Street,Great Portland Street,Green Park").split(",");

        //Multidimensional array of Tube-lines and Stations
        ...
        do {
            //JFrame JOptionPane is used for display Dialog and take input from user
